...
const PLANS: Plan[] = [
  {
    name: "Starter",
    tagline: "The entry point for a growing care team.",
    monthly: 149,
    included: null,
    extraRate: null,
    seatRate: 4,
  ...
  {
    name: "Lightforce",
    tagline: "The full back office for a growing agency.",
    monthly: 524,
    included: 40,
    extraRate: 4,
    cta: { label: "Start with the demo", href: "/login", variant: "primary" },
    features: [
      ...
      "Client invoicing & margin on every shift",
      "Limited automations",
    ],
  },
  {
    name: "Midweight",
    tagline: "Staffing, AI matching and finance integrations.",
    monthly: 1236,
    included: 150,
    extraRate: 3,
    popular: true,
    cta: { label: "Start with the demo", href: "/login", variant: "primary" },
    features: [
      "Everything in Lightforce",
      "Staffing: candidates, placements, AI shift matching",
  ...
  {
    name: "Heavy Duty",
    tagline: "Enterprise, multi-agency and the full HR suite.",
    monthly: 2500,
    included: null,
    extraRate: null,
    cta: { label: "Contact us", href: "mailto:Wisdom@aultrum.co.uk", variant: "outline" },
    features: [
      "Everything in Midweight",
      "HR suite: records, policies, onboarding",
      "Multi-agency / multi-branch",
      "Unlimited Agent Runners & automations",
